<!-- navbar --> 
      <nav class="navbar navbar-expand-md navbar-light bg-light;" style="background-color: #5F9EA0;">
      <a class="navbar-brand" href="index.php" style="color : white;"><b>ABC BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="viewAll.php" style="color : white;"><b>View All</b></a>
              </li>
              <li class="nav-item">
